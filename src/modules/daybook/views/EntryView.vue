<template>
  <div class="entry-title d-flex justify-content-between p-2">
    <div>
      <span class="text-success fs-3 fw-bold">27</span>
      <span class="mx-1 fs-3">Febrero</span>
      <span class="mx-2 fs-4 fw-light">2022, domingo</span>
    </div>
...
export default {
  components: {
    Fab: defineAsyncComponent(() => import(/* webpackChunkName: "fab" */ '../components/Fab'))
  }
}
</script>
